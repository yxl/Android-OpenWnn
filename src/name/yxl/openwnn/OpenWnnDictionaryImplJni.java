...
public class OpenWnnDictionaryImplJni {
     ...
     *
     * @see name.yxl.openwnn.WnnDictionary#APPROX_PATTERN_EN_TOUPPER
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#setApproxPattern
     */
    public static final int APPROX_PATTERN_EN_TOUPPER               = WnnDictionary.APPROX_PATTERN_EN_TOUPPER;
    /**
     * Constant about the approximate pattern (for JNI native library)
     *
     * @see name.yxl.openwnn.WnnDictionary#APPROX_PATTERN_EN_TOLOWER
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#setApproxPattern
     */
     ...
     * Constant about the approximate pattern (for JNI native library)
     *
     * @see name.yxl.openwnn.WnnDictionary#APPROX_PATTERN_EN_QWERTY_NEAR
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#setApproxPattern
     */
     ...
     * Constant about the approximate pattern (for JNI native library)
     *
     * @see name.yxl.openwnn.WnnDictionary#APPROX_PATTERN_EN_QWERTY_NEAR_UPPER
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#setApproxPattern
     */
     ...
     * Constant about the approximate pattern (for JNI native library)
     *
     * @see name.yxl.openwnn.WnnDictionary#APPROX_PATTERN_JAJP_12KEY_NORMAL
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#setApproxPattern
     */
     ...
     *
     * @see name.yxl.openwnn.WnnDictionary#SEARCH_EXACT
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#searchWord
     */
    public static final int SEARCH_EXACT                           = WnnDictionary.SEARCH_EXACT;
    /**
     * Constant about the search operation (for JNI native library)
     *
     * @see name.yxl.openwnn.WnnDictionary#SEARCH_PREFIX
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#searchWord
     */
     ...
     * Constant about the search operation (for JNI native library)
     *
     * @see name.yxl.openwnn.WnnDictionary#SEARCH_LINK
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#searchWord
     */
     ...
     *
     * @see name.yxl.openwnn.WnnDictionary#ORDER_BY_FREQUENCY
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#searchWord
     */
     ...
     * Constant about the sort order (for JNI native library)
     *
     * @see name.yxl.openwnn.WnnDictionary#ORDER_BY_KEY
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#searchWord
     */
     ...
     * @see name.yxl.openwnn.WnnDictionary#POS_TYPE_V1
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
    public static final int POS_TYPE_V1                             = WnnDictionary.POS_TYPE_V1;
    /**
     * Type of a part of speech (for JNI native library)
     * @see name.yxl.openwnn.WnnDictionary#POS_TYPE_V2
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
    ...
    /**
     * Type of a part of speech (for JNI native library)
     * @see name.yxl.openwnn.WnnDictionary#POS_TYPE_V3
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
    ...
    /**
     * Type of a part of speech (for JNI native library)
     * @see name.yxl.openwnn.WnnDictionary#POS_TYPE_BUNTOU
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
    ...
    /**
     * Type of a part of speech (for JNI native library)
     * @see name.yxl.openwnn.WnnDictionary#POS_TYPE_TANKANJI
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
    ...
    /**
     * Type of a part of speech (for JNI native library)
     * @see name.yxl.openwnn.WnnDictionary#POS_TYPE_SUUJI
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
    ...
    /**
     * Type of a part of speech (for JNI native library)
     * @see name.yxl.openwnn.WnnDictionary#POS_TYPE_MEISI
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
    ...
    /**
     * Type of a part of speech (for JNI native library)
     * @see name.yxl.openwnn.WnnDictionary#POS_TYPE_JINMEI
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
    ...
    /**
     * Type of a part of speech (for JNI native library)
     * @see name.yxl.openwnn.WnnDictionary#POS_TYPE_CHIMEI
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
    ...
    /**
     * Type of a part of speech (for JNI native library)
     * @see name.yxl.openwnn.WnnDictionary#POS_TYPE_KIGOU
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#getLeftPartOfSpeechSpecifiedType
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#getRightPartOfSpeechSpecifiedType
     */
     ...
     *
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#getNextWord
     * @param work      The internal work area
     ...
     * @param type          The type of a part of speech
     * @return              0 if type is not found; <0 if an error occur; >0 The part of speech
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#POS_TYPE_V1
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#POS_TYPE_V2
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#POS_TYPE_V3
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#POS_TYPE_BUNTOU
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#POS_TYPE_TANKANJI
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#POS_TYPE_SUUJI
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#POS_TYPE_MEISI
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#POS_TYPE_JINMEI
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#POS_TYPE_CHIMEI
     * @see name.yxl.openwnn.OpenWnnDictionaryImplJni#POS_TYPE_KIGOU
     */
